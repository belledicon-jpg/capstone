          ...
          <ScrollReveal delay={100}>
            ...
            <aside className="dashboard-card p-5 sm:p-6">
              ...
              <div className="space-y-3">
                ...
                <Button variant="outline" className="mt-4 w-full rounded-xl border-slate-200 text-slate-700 hover:bg-slate-50 dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-800">Open alert center</Button>
              </aside>
            </section>
          </ScrollReveal>
      </main>
