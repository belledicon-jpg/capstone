...
export const AIChatWidget = () => {
  ...
  return (
    <div className="fixed bottom-5 right-4 z-50 sm:bottom-6 sm:right-6">
      {open && (
        <section
          aria-label="GovServer AI assistant"
        ...
        >
          <header className="flex items-center gap-3 bg-[#0d1b34] px-4 py-3.5 text-white">
            ...
            <div className="flex-1"><h2 className="font-heading text-sm font-bold">GovServer Assistant</h2><p className="text-[11px] text-blue-200">Dashboard insights · Online</p></div>
          ...
          <form onSubmit={submit} className="flex gap-2 border-t border-slate-200 bg-white p-3 dark:border-slate-700 dark:bg-slate-900">
            <label htmlFor="ai-question" className="sr-only">Ask GovServer</label>
